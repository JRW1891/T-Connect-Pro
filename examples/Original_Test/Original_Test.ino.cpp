# 1 "C:\\Users\\XK\\AppData\\Local\\Temp\\tmpt63qsk76"
#include <Arduino.h>
# 1 "D:/Information/visual_studio_code/gitHub/T-Connect-Pro/examples/Original_Test/Original_Test.ino"
# 9 "D:/Information/visual_studio_code/gitHub/T-Connect-Pro/examples/Original_Test/Original_Test.ino"
#include <Arduino.h>
...
Arduino_DataBus *bus = new Arduino_HWSPI(
    SCREEN_DC , SCREEN_CS , SCREEN_SCLK ,
    SCREEN_MOSI , SCREEN_MISO );

Arduino_GFX *gfx = new Arduino_ST7796(
    bus, SCREEN_RST , Current_Rotation , true ,
...
void setup();
void loop();
#line 530 "D:/Information/visual_studio_code/gitHub/T-Connect-Pro/examples/Original_Test/Original_Test.ino"
void Lora_Operation_Interrupt(void)
{
...
bool Ethernet_Initialization_Assertion(String *assertion)
{
    ...
    if (Ethernet.begin(mac, 10000, 10000) == 0)
    {
        ...
        Serial.println("");
# 917 "D:/Information/visual_studio_code/gitHub/T-Connect-Pro/examples/Original_Test/Original_Test.ino"
...
void GFX_Print_RS485_Info_Loop(void)
{
    ...
    if (RS485_OP.device_1.connection_status != RS485_OP.state::PAUSE)
    {
        while (Serial1.available() > 0)
        {
            ...
            {
                if (Uart_Check_Dynamic_Data(uart_receive_package, RS485_OP.device_1.send_data) == false)
                {
                ...
                else if (Uart_Check_Static_Data(uart_receive_package, RS485_OP.send_package_1) == false)
                {
    ...
    if (RS485_OP.device_2.connection_status != RS485_OP.state::PAUSE)
    {
        while (Serial2.available() > 0)
        {
            ...
            if (uart_receive_package[0] == 0x0A)
            {
                if (Uart_Check_Dynamic_Data(uart_receive_package, RS485_OP.device_2.send_data) == false)
                {
                ...
                else if (Uart_Check_Static_Data(uart_receive_package, RS485_OP.send_package_2) == false)
                {
...
# 2071 "D:/Information/visual_studio_code/gitHub/T-Connect-Pro/examples/Original_Test/Original_Test.ino"
...
void GFX_Print_SX12xx_Info_Loop()
{
    if (Lora_Op.initialization_flag == true)
    {
        ...
        if (millis() > CycleTime_3)
        {
            ...
            if (Lora_Op.device_1.error_count > 20)
            {
...
void Original_Test_4_Loop()
{
# 2747 "D:/Information/visual_studio_code/gitHub/T-Connect-Pro/examples/Original_Test/Original_Test.ino"
    gfx->fillScreen(BLACK);
