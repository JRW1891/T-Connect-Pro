...
public:
	...
	virtual bool queryUsingDcdc(void) { return true; }
	virtual bool queryUsingDIO2AsRfSwitch(void) { return true; }
	virtual bool queryUsingDIO3AsTCXOSwitch(void) { return true; }
